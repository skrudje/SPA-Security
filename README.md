...
Одностраничное веб-приложение (SPA) для мониторинга и управления контрольно-пропускными пунктами (КПП) и объектами охраны. Разработано в рамках расчетно-графической работы по дисциплине «Технологии и методы программирования».
